...
document.getElementById('btnEnviar').addEventListener('click', () => {
  ...
  const mensagem =
    ...
    `1 Tempo de queda: ${encodeURIComponent(respostas.pergunta1)}%0A` +
    `2 Grau de calvície: ${encodeURIComponent(respostas.pergunta2)}%0A` +
    `3 Objetivo: ${encodeURIComponent(respostas.pergunta3)}`;
...
const todasPessoas = [0, 1, 2, 3, 4, 5];
